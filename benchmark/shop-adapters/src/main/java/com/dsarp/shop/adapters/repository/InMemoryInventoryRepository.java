...
/** In-memory in memory inventory repository for reproducible local scenarios. */
public final class InMemoryInventoryRepository {
    private final InventoryReservationService policy;
    private final List<String> journal = new ArrayList<>();

    public InMemoryInventoryRepository(InventoryReservationService policy) {
