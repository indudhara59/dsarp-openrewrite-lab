...
/** In-memory in memory payment gateway for reproducible local scenarios. */
public final class InMemoryPaymentGateway {
    private final PaymentAuthorizationService policy;
    private final List<String> journal = new ArrayList<>();

    public InMemoryPaymentGateway(PaymentAuthorizationService policy) {
