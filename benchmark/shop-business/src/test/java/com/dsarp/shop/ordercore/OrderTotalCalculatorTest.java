...
class OrderTotalCalculatorTest {
    ...
    void preservesOrderInvariantWhileConsultingDiscountPolicy() {
        OrderContext context = new OrderContext("CORE-17", "C-17", new BigDecimal("75.00"),
                1, "DE", Instant.parse("2026-01-15T10:00:00Z"), Map.of());
        OrderTotalCalculator service = new OrderTotalCalculator(new FlashSaleDiscountPolicy());
