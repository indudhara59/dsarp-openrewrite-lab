...
class AbandonedCartRecoveryPolicyTest {
    @Test
    void calculatesBoundedRepeatableDiscount() {
        OrderContext context = new OrderContext("P-7", "C-7", new BigDecimal("200.00"),
                2, "DE", Instant.parse("2026-01-15T10:00:00Z"), Map.of());
        AbandonedCartRecoveryPolicy policy = new AbandonedCartRecoveryPolicy();
        ...
        assertThat(policy.policyName()).isEqualTo("AbandonedCartRecoveryPolicy");
