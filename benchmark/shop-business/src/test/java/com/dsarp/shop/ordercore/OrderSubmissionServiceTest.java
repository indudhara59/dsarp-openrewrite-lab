...
class OrderSubmissionServiceTest {
    ...
    void preservesOrderInvariantWhileConsultingDiscountPolicy() {
        OrderContext context = new OrderContext("CORE-15", "C-15", new BigDecimal("75.00"),
                1, "DE", Instant.parse("2026-01-15T10:00:00Z"), Map.of());
        OrderSubmissionService service = new OrderSubmissionService(new FlashSaleDiscountPolicy());
