...
class OrderDecisionServiceTest {
    ...
    void preservesOrderInvariantWhileConsultingDiscountPolicy() {
        OrderContext context = new OrderContext("CORE-21", "C-21", new BigDecimal("75.00"),
                1, "DE", Instant.parse("2026-01-15T10:00:00Z"), Map.of());
        OrderDecisionService service = new OrderDecisionService(new FlashSaleDiscountPolicy());
