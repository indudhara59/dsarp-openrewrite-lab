...
class OrderLifecycleServiceTest {
    ...
    void preservesOrderInvariantWhileConsultingDiscountPolicy() {
        OrderContext context = new OrderContext("CORE-20", "C-20", new BigDecimal("75.00"),
                1, "DE", Instant.parse("2026-01-15T10:00:00Z"), Map.of());
        OrderLifecycleService service = new OrderLifecycleService(new FlashSaleDiscountPolicy());
