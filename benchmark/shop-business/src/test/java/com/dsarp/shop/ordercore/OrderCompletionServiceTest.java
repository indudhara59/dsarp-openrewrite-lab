...
class OrderCompletionServiceTest {
    ...
    void preservesOrderInvariantWhileConsultingDiscountPolicy() {
        OrderContext context = new OrderContext("CORE-23", "C-23", new BigDecimal("75.00"),
                1, "DE", Instant.parse("2026-01-15T10:00:00Z"), Map.of());
        OrderCompletionService service = new OrderCompletionService(new FlashSaleDiscountPolicy());
