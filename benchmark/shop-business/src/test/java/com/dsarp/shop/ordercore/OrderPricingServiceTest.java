...
class OrderPricingServiceTest {
    ...
    void preservesOrderInvariantWhileConsultingDiscountPolicy() {
        OrderContext context = new OrderContext("CORE-13", "C-13", new BigDecimal("75.00"),
                1, "DE", Instant.parse("2026-01-15T10:00:00Z"), Map.of());
        OrderPricingService service = new OrderPricingService(new FlashSaleDiscountPolicy());
