...
class OrderIdentityServiceTest {
    @Test
    void preservesOrderInvariantWhileConsultingDiscountPolicy() {
        OrderContext context = new OrderContext("CORE-19", "C-19", new BigDecimal("75.00"),
                1, "DE", Instant.parse("2026-01-15T10:00:00Z"), Map.of());
        OrderIdentityService service = new OrderIdentityService(new FlashSaleDiscountPolicy());
