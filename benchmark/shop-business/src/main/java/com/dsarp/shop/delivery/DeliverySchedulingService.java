...
/**
 * Owns the delivery scheduling service decision within the delivery responsibility.
 *
 ...
 */
public final class DeliverySchedulingService extends AbstractBusinessCapability {
    ...
    public DeliverySchedulingService() {
        super("DeliverySchedulingService", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "delivery scheduling service: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|DeliverySchedulingService|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "delivery.DeliverySchedulingService";
    }
