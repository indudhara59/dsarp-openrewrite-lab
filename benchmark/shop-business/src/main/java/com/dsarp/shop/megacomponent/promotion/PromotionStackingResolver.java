...
/**
 * Owns the promotion stacking resolver decision within the promotion responsibility.
 *
 ...
 */
public final class PromotionStackingResolver extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 45;
    private static final int RESPONSIBILITY_WEIGHT = -4;

    public PromotionStackingResolver() {
        super("PromotionStackingResolver", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "promotion stacking resolver: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|PromotionStackingResolver|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "promotion.PromotionStackingResolver";
    }
