...
public final class OrderCompletionService {
    ...
    public OrderCompletionService(DiscountPolicy discountPolicy) {
    ...
    public CapabilityDecision decide(OrderContext context) {
        ...
        int score = Math.max(0, Math.min(100, 100 - payable.remainder(BigDecimal.valueOf(42)).intValue()));
        return new CapabilityDecision("OrderCompletionService", context.itemCount() > 0, score,
    ...
    public String capabilityKey() {
        return "ordercore.OrderCompletionService";
    }
