...
/**
 * Owns the order audit assembler decision within the audit responsibility.
 *
 ...
 */
public final class OrderAuditAssembler extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 52;
    private static final int RESPONSIBILITY_WEIGHT = -2;

    public OrderAuditAssembler() {
        super("OrderAuditAssembler", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "order audit assembler: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|OrderAuditAssembler|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "audit.OrderAuditAssembler";
    }
