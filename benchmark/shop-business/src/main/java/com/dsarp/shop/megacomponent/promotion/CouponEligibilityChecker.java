...
/**
 * Owns the coupon eligibility checker decision within the promotion responsibility.
 *
 ...
 */
public final class CouponEligibilityChecker extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 44;
    private static final int RESPONSIBILITY_WEIGHT = 4;

    public CouponEligibilityChecker() {
        super("CouponEligibilityChecker", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "coupon eligibility checker: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|CouponEligibilityChecker|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "promotion.CouponEligibilityChecker";
    }
