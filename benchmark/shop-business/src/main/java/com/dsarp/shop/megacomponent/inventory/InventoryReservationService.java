...
/**
 * Owns the inventory reservation service decision within the inventory responsibility.
 *
 ...
 */
public final class InventoryReservationService extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 43;
    private static final int RESPONSIBILITY_WEIGHT = 2;

    public InventoryReservationService() {
        super("InventoryReservationService", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "inventory reservation service: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|InventoryReservationService|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "inventory.InventoryReservationService";
    }
