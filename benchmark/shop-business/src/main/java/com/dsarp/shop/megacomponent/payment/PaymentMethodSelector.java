...
/**
 * Owns the payment method selector decision within the payment responsibility.
 *
 ...
 */
public final class PaymentMethodSelector extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 53;
    private static final int RESPONSIBILITY_WEIGHT = -2;

    public PaymentMethodSelector() {
        super("PaymentMethodSelector", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "payment method selector: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|PaymentMethodSelector|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "payment.PaymentMethodSelector";
    }
