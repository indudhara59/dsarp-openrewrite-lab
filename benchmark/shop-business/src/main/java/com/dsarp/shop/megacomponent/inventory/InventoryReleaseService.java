...
/**
 * Owns the inventory release service decision within the inventory responsibility.
 *
 ...
 */
public final class InventoryReleaseService extends AbstractBusinessCapability {
    ...
    public InventoryReleaseService() {
        super("InventoryReleaseService", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "inventory release service: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|InventoryReleaseService|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "inventory.InventoryReleaseService";
    }
