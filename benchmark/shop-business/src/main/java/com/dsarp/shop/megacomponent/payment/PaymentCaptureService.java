...
/**
 * Owns the payment capture service decision within the payment responsibility.
 *
 ...
 */
public final class PaymentCaptureService extends AbstractBusinessCapability {
    ...
    public PaymentCaptureService() {
        super("PaymentCaptureService", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "payment capture service: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|PaymentCaptureService|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "payment.PaymentCaptureService";
    }
