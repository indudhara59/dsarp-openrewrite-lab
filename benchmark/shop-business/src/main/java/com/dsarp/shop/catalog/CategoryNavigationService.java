...
/**
 * Owns the category navigation service decision within the catalog responsibility.
 *
 ...
 */
public final class CategoryNavigationService extends AbstractBusinessCapability {
    ...
    public CategoryNavigationService() {
        super("CategoryNavigationService", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "category navigation service: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|CategoryNavigationService|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "catalog.CategoryNavigationService";
    }
