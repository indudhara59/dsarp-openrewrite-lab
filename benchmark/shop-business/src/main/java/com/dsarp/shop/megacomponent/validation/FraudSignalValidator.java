...
/**
 * Owns the fraud signal validator decision within the validation responsibility.
 *
 ...
 */
public final class FraudSignalValidator extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 49;
    private static final int RESPONSIBILITY_WEIGHT = 3;

    public FraudSignalValidator() {
        super("FraudSignalValidator", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "fraud signal validator: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|FraudSignalValidator|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "validation.FraudSignalValidator";
    }
