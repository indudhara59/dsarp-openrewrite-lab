...
/**
 * Owns the return authorization service decision within the returns responsibility.
 *
 ...
 */
public final class ReturnAuthorizationService extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 57;
    private static final int RESPONSIBILITY_WEIGHT = 0;

    public ReturnAuthorizationService() {
        super("ReturnAuthorizationService", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "return authorization service: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|ReturnAuthorizationService|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "returns.ReturnAuthorizationService";
    }
