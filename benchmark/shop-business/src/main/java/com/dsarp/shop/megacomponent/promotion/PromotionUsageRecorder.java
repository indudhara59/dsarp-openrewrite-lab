...
/**
 * Owns the promotion usage recorder decision within the promotion responsibility.
 *
 ...
 */
public final class PromotionUsageRecorder extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 49;
    private static final int RESPONSIBILITY_WEIGHT = 0;

    public PromotionUsageRecorder() {
        super("PromotionUsageRecorder", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "promotion usage recorder: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|PromotionUsageRecorder|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "promotion.PromotionUsageRecorder";
    }
