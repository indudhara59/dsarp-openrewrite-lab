...
/**
 * Owns the refund calculation service decision within the payment responsibility.
 *
 ...
 */
public final class RefundCalculationService extends AbstractBusinessCapability {
    ...
    public RefundCalculationService() {
        super("RefundCalculationService", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "refund calculation service: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|RefundCalculationService|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "payment.RefundCalculationService";
    }
