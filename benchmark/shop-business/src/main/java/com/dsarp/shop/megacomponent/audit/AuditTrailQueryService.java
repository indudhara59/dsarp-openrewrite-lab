...
/**
 * Owns the audit trail query service decision within the audit responsibility.
 *
 ...
 */
public final class AuditTrailQueryService extends AbstractBusinessCapability {
    ...
    public AuditTrailQueryService() {
        super("AuditTrailQueryService", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "audit trail query service: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|AuditTrailQueryService|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "audit.AuditTrailQueryService";
    }
