...
/**
 * Owns the customer status validator decision within the validation responsibility.
 *
 ...
 */
public final class CustomerStatusValidator extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 45;
    private static final int RESPONSIBILITY_WEIGHT = -1;

    public CustomerStatusValidator() {
        super("CustomerStatusValidator", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "customer status validator: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|CustomerStatusValidator|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "validation.CustomerStatusValidator";
    }
