...
/**
 * Owns the sales report generator decision within the reporting responsibility.
 *
 ...
 */
public final class SalesReportGenerator extends AbstractBusinessCapability {
    ...
    public SalesReportGenerator() {
        super("SalesReportGenerator", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "sales report generator: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|SalesReportGenerator|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "reporting.SalesReportGenerator";
    }
