...
/**
 * Owns the cart line service decision within the cart responsibility.
 *
 ...
 */
public final class CartLineService extends AbstractBusinessCapability {
    ...
    public CartLineService() {
        super("CartLineService", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "cart line service: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|CartLineService|" + decision.score() + "|" + decision.accepted();
    }
