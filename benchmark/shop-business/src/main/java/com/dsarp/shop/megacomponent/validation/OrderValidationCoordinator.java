...
/**
 * Owns the order validation coordinator decision within the validation responsibility.
 *
 ...
 */
public final class OrderValidationCoordinator extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 43;
    private static final int RESPONSIBILITY_WEIGHT = -3;

    public OrderValidationCoordinator() {
        super("OrderValidationCoordinator", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "order validation coordinator: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|OrderValidationCoordinator|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "validation.OrderValidationCoordinator";
    }
