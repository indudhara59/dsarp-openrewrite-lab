...
/**
 * Owns the catalog search service decision within the catalog responsibility.
 *
 ...
 */
public final class CatalogSearchService extends AbstractBusinessCapability {
    ...
    public CatalogSearchService() {
        super("CatalogSearchService", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "catalog search service: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|CatalogSearchService|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "catalog.CatalogSearchService";
    }
