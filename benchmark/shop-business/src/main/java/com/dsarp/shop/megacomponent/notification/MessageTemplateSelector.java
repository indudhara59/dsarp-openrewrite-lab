...
/**
 * Owns the message template selector decision within the notification responsibility.
 *
 ...
 */
public final class MessageTemplateSelector extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 42;
    private static final int RESPONSIBILITY_WEIGHT = -3;

    public MessageTemplateSelector() {
        super("MessageTemplateSelector", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "message template selector: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|MessageTemplateSelector|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "notification.MessageTemplateSelector";
    }
