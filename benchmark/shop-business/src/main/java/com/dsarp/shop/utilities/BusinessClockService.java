...
/**
 * Owns the business clock service decision within the utilities responsibility.
 *
 ...
 */
public final class BusinessClockService extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 44;
    private static final int RESPONSIBILITY_WEIGHT = 5;

    public BusinessClockService() {
        super("BusinessClockService", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "business clock service: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|BusinessClockService|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "utilities.BusinessClockService";
    }
