...
public final class OrderTotalCalculator {
    ...
    public OrderTotalCalculator(DiscountPolicy discountPolicy) {
    ...
    public CapabilityDecision decide(OrderContext context) {
        ...
        int score = Math.max(0, Math.min(100, 100 - payable.remainder(BigDecimal.valueOf(36)).intValue()));
        return new CapabilityDecision("OrderTotalCalculator", context.itemCount() > 0, score,
    ...
    public String capabilityKey() {
        return "ordercore.OrderTotalCalculator";
    }
