...
/**
 * Owns the return eligibility service decision within the returns responsibility.
 *
 ...
 */
public final class ReturnEligibilityService extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 56;
    private static final int RESPONSIBILITY_WEIGHT = -1;

    public ReturnEligibilityService() {
        super("ReturnEligibilityService", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "return eligibility service: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|ReturnEligibilityService|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "returns.ReturnEligibilityService";
    }
