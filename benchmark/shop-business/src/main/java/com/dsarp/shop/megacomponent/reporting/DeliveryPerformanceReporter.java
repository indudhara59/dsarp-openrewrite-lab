...
/**
 * Owns the delivery performance reporter decision within the reporting responsibility.
 *
 ...
 */
public final class DeliveryPerformanceReporter extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 49;
    private static final int RESPONSIBILITY_WEIGHT = 4;

    public DeliveryPerformanceReporter() {
        super("DeliveryPerformanceReporter", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "delivery performance reporter: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|DeliveryPerformanceReporter|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "reporting.DeliveryPerformanceReporter";
    }
