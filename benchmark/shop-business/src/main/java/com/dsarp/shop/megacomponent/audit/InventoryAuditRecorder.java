...
/**
 * Owns the inventory audit recorder decision within the audit responsibility.
 *
 ...
 */
public final class InventoryAuditRecorder extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 54;
    private static final int RESPONSIBILITY_WEIGHT = 0;

    public InventoryAuditRecorder() {
        super("InventoryAuditRecorder", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "inventory audit recorder: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|InventoryAuditRecorder|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "audit.InventoryAuditRecorder";
    }
