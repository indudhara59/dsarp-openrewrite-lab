...
/**
 * Owns the payment authorization service decision within the payment responsibility.
 *
 ...
 */
public final class PaymentAuthorizationService extends AbstractBusinessCapability {
    ...
    public PaymentAuthorizationService() {
        super("PaymentAuthorizationService", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "payment authorization service: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|PaymentAuthorizationService|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "payment.PaymentAuthorizationService";
    }
