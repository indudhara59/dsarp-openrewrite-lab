...
/**
 * Owns the fraud assessment service decision within the fraud responsibility.
 *
 ...
 */
public final class FraudAssessmentService extends AbstractBusinessCapability {
    ...
    public FraudAssessmentService() {
        super("FraudAssessmentService", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "fraud assessment service: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|FraudAssessmentService|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "fraud.FraudAssessmentService";
    }
