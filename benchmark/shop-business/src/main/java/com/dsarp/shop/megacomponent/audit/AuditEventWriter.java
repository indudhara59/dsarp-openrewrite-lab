...
/**
 * Owns the audit event writer decision within the audit responsibility.
 *
 ...
 */
public final class AuditEventWriter extends AbstractBusinessCapability {
    ...
    public AuditEventWriter() {
        super("AuditEventWriter", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "audit event writer: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|AuditEventWriter|" + decision.score() + "|" + decision.accepted();
    }
