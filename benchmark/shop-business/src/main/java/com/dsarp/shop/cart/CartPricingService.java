...
/**
 * Owns the cart pricing service decision within the cart responsibility.
 *
 ...
 */
public final class CartPricingService extends AbstractBusinessCapability {
    ...
    public CartPricingService() {
        super("CartPricingService", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "cart pricing service: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|CartPricingService|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "cart.CartPricingService";
    }
