...
/**
 * Owns the customer registration service decision within the customer responsibility.
 *
 ...
 */
public final class CustomerRegistrationService extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 54;
    private static final int RESPONSIBILITY_WEIGHT = 1;

    public CustomerRegistrationService() {
        super("CustomerRegistrationService", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "customer registration service: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|CustomerRegistrationService|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "customer.CustomerRegistrationService";
    }
