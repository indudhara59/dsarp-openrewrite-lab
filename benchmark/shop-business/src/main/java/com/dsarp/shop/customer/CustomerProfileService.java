...
/**
 * Owns the customer profile service decision within the customer responsibility.
 *
 ...
 */
public final class CustomerProfileService extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 55;
    private static final int RESPONSIBILITY_WEIGHT = 2;

    public CustomerProfileService() {
        super("CustomerProfileService", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "customer profile service: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|CustomerProfileService|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "customer.CustomerProfileService";
    }
