...
/**
 * Owns the customer cohort reporter decision within the reporting responsibility.
 *
 ...
 */
public final class CustomerCohortReporter extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 48;
    private static final int RESPONSIBILITY_WEIGHT = 3;

    public CustomerCohortReporter() {
        super("CustomerCohortReporter", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "customer cohort reporter: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|CustomerCohortReporter|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "reporting.CustomerCohortReporter";
    }
