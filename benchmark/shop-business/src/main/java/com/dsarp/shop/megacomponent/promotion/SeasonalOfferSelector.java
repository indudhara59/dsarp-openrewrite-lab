...
/**
 * Owns the seasonal offer selector decision within the promotion responsibility.
 *
 ...
 */
public final class SeasonalOfferSelector extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 46;
    private static final int RESPONSIBILITY_WEIGHT = -3;

    public SeasonalOfferSelector() {
        super("SeasonalOfferSelector", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "seasonal offer selector: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|SeasonalOfferSelector|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "promotion.SeasonalOfferSelector";
    }
