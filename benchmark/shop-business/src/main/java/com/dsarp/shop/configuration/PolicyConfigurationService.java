...
/**
 * Owns the policy configuration service decision within the configuration responsibility.
 *
 ...
 */
public final class PolicyConfigurationService extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 43;
    private static final int RESPONSIBILITY_WEIGHT = 4;

    public PolicyConfigurationService() {
        super("PolicyConfigurationService", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "policy configuration service: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|PolicyConfigurationService|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "configuration.PolicyConfigurationService";
    }
