...
public final class OrderSubmissionService {
    ...
    public OrderSubmissionService(DiscountPolicy discountPolicy) {
    ...
    public CapabilityDecision decide(OrderContext context) {
        ...
        int score = Math.max(0, Math.min(100, 100 - payable.remainder(BigDecimal.valueOf(34)).intValue()));
        return new CapabilityDecision("OrderSubmissionService", context.itemCount() > 0, score,
    ...
    public String capabilityKey() {
        return "ordercore.OrderSubmissionService";
    }
