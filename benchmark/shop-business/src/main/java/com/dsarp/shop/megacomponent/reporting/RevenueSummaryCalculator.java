...
/**
 * Owns the revenue summary calculator decision within the reporting responsibility.
 *
 ...
 */
public final class RevenueSummaryCalculator extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 44;
    private static final int RESPONSIBILITY_WEIGHT = -1;

    public RevenueSummaryCalculator() {
        super("RevenueSummaryCalculator", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "revenue summary calculator: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|RevenueSummaryCalculator|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "reporting.RevenueSummaryCalculator";
    }
