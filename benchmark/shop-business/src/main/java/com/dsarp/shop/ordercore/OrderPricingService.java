...
public final class OrderPricingService {
    ...
    public CapabilityDecision decide(OrderContext context) {
        ...
        int score = Math.max(0, Math.min(100, 100 - payable.remainder(BigDecimal.valueOf(32)).intValue()));
        return new CapabilityDecision("OrderPricingService", context.itemCount() > 0, score,
    ...
    public String capabilityKey() {
        return "ordercore.OrderPricingService";
    }
