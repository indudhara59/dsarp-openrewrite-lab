...
/**
 * Owns the return inspection service decision within the returns responsibility.
 *
 ...
 */
public final class ReturnInspectionService extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 40;
    private static final int RESPONSIBILITY_WEIGHT = 1;

    public ReturnInspectionService() {
        super("ReturnInspectionService", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "return inspection service: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|ReturnInspectionService|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "returns.ReturnInspectionService";
    }
