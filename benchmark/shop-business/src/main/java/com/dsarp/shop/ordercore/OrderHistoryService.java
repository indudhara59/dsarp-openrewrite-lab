...
public final class OrderHistoryService {
    ...
    public OrderHistoryService(DiscountPolicy discountPolicy) {
    ...
    public CapabilityDecision decide(OrderContext context) {
        ...
        int score = Math.max(0, Math.min(100, 100 - payable.remainder(BigDecimal.valueOf(41)).intValue()));
        return new CapabilityDecision("OrderHistoryService", context.itemCount() > 0, score,
    ...
    public String capabilityKey() {
        return "ordercore.OrderHistoryService";
    }
