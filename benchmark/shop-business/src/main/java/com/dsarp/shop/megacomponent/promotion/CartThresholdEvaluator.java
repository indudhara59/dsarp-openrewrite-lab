...
/**
 * Owns the cart threshold evaluator decision within the promotion responsibility.
 *
 ...
 */
public final class CartThresholdEvaluator extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 48;
    private static final int RESPONSIBILITY_WEIGHT = -1;

    public CartThresholdEvaluator() {
        super("CartThresholdEvaluator", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "cart threshold evaluator: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|CartThresholdEvaluator|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "promotion.CartThresholdEvaluator";
    }
