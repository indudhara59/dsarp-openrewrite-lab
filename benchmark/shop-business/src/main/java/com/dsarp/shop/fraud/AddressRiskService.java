...
/**
 * Owns the address risk service decision within the fraud responsibility.
 *
 ...
 */
public final class AddressRiskService extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 54;
    private static final int RESPONSIBILITY_WEIGHT = -3;

    public AddressRiskService() {
        super("AddressRiskService", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "address risk service: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|AddressRiskService|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "fraud.AddressRiskService";
    }
