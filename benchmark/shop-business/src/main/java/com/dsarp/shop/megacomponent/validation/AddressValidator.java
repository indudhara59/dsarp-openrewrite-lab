...
/**
 * Owns the address validator decision within the validation responsibility.
 *
 ...
 */
public final class AddressValidator extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 44;
    private static final int RESPONSIBILITY_WEIGHT = -2;

    public AddressValidator() {
        super("AddressValidator", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "address validator: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|AddressValidator|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "validation.AddressValidator";
    }
