...
/**
 * Owns the order line validator decision within the validation responsibility.
 *
 ...
 */
public final class OrderLineValidator extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 46;
    private static final int RESPONSIBILITY_WEIGHT = 0;

    public OrderLineValidator() {
        super("OrderLineValidator", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "order line validator: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|OrderLineValidator|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "validation.OrderLineValidator";
    }
