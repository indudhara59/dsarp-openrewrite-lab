...
/**
 * Owns the order volume analyzer decision within the reporting responsibility.
 *
 ...
 */
public final class OrderVolumeAnalyzer extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 45;
    private static final int RESPONSIBILITY_WEIGHT = 0;

    public OrderVolumeAnalyzer() {
        super("OrderVolumeAnalyzer", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "order volume analyzer: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|OrderVolumeAnalyzer|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "reporting.OrderVolumeAnalyzer";
    }
