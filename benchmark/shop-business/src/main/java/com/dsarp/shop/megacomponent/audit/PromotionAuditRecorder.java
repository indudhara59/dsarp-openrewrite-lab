...
/**
 * Owns the promotion audit recorder decision within the audit responsibility.
 *
 ...
 */
public final class PromotionAuditRecorder extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 55;
    private static final int RESPONSIBILITY_WEIGHT = 1;

    public PromotionAuditRecorder() {
        super("PromotionAuditRecorder", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "promotion audit recorder: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|PromotionAuditRecorder|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "audit.PromotionAuditRecorder";
    }
