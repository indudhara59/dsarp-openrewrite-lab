...
public final class CatalogPromotionAdapter implements DiscountPolicy {
    private static final BigDecimal RATE = new BigDecimal("0.06");
    ...
    public String policyName() {
        return "CatalogPromotionAdapter";
    }
