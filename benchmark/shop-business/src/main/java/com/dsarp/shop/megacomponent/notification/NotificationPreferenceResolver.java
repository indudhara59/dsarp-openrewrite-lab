...
/**
 * Owns the notification preference resolver decision within the notification responsibility.
 *
 ...
 */
public final class NotificationPreferenceResolver extends AbstractBusinessCapability {
    ...
    public NotificationPreferenceResolver() {
        super("NotificationPreferenceResolver", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "notification preference resolver: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|NotificationPreferenceResolver|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "notification.NotificationPreferenceResolver";
    }
