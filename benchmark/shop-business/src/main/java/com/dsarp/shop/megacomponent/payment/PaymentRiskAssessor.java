...
/**
 * Owns the payment risk assessor decision within the payment responsibility.
 *
 ...
 */
public final class PaymentRiskAssessor extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 54;
    private static final int RESPONSIBILITY_WEIGHT = -1;

    public PaymentRiskAssessor() {
        super("PaymentRiskAssessor", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "payment risk assessor: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|PaymentRiskAssessor|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "payment.PaymentRiskAssessor";
    }
