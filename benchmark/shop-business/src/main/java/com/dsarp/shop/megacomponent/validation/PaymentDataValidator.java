...
/**
 * Owns the payment data validator decision within the validation responsibility.
 *
 ...
 */
public final class PaymentDataValidator extends AbstractBusinessCapability {
    ...
    public PaymentDataValidator() {
        super("PaymentDataValidator", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "payment data validator: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|PaymentDataValidator|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "validation.PaymentDataValidator";
    }
