...
/**
 * Owns the delivery update notifier decision within the notification responsibility.
 *
 ...
 */
public final class DeliveryUpdateNotifier extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 53;
    private static final int RESPONSIBILITY_WEIGHT = 3;

    public DeliveryUpdateNotifier() {
        super("DeliveryUpdateNotifier", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "delivery update notifier: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|DeliveryUpdateNotifier|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "notification.DeliveryUpdateNotifier";
    }
