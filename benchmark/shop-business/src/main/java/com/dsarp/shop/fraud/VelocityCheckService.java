...
/**
 * Owns the velocity check service decision within the fraud responsibility.
 *
 ...
 */
public final class VelocityCheckService extends AbstractBusinessCapability {
    ...
    public VelocityCheckService() {
        super("VelocityCheckService", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "velocity check service: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|VelocityCheckService|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "fraud.VelocityCheckService";
    }
