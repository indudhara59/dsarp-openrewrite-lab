...
/**
 * Owns the cart abandonment service decision within the cart responsibility.
 *
 ...
 */
public final class CartAbandonmentService extends AbstractBusinessCapability {
    ...
    public CartAbandonmentService() {
        super("CartAbandonmentService", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "cart abandonment service: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|CartAbandonmentService|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "cart.CartAbandonmentService";
    }
