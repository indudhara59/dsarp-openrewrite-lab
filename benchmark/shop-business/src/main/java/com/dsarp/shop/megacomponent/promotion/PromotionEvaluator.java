...
/**
 * Owns the promotion evaluator decision within the promotion responsibility.
 *
 ...
 */
public final class PromotionEvaluator extends AbstractBusinessCapability {
    ...
    public PromotionEvaluator() {
        super("PromotionEvaluator", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "promotion evaluator: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|PromotionEvaluator|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "promotion.PromotionEvaluator";
    }
