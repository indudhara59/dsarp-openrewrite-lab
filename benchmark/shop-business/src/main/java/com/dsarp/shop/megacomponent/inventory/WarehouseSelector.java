...
/**
 * Owns the warehouse selector decision within the inventory responsibility.
 *
 ...
 */
public final class WarehouseSelector extends AbstractBusinessCapability {
    ...
    public WarehouseSelector() {
        super("WarehouseSelector", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "warehouse selector: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|WarehouseSelector|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "inventory.WarehouseSelector";
    }
