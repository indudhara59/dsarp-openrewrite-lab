...
/**
 * Owns the stock allocation planner decision within the inventory responsibility.
 *
 ...
 */
public final class StockAllocationPlanner extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 45;
    private static final int RESPONSIBILITY_WEIGHT = 4;

    public StockAllocationPlanner() {
        super("StockAllocationPlanner", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "stock allocation planner: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|StockAllocationPlanner|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "inventory.StockAllocationPlanner";
    }
