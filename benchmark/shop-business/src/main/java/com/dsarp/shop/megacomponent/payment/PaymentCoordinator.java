...
/**
 * Owns the payment coordinator decision within the payment responsibility.
 *
 ...
 */
public final class PaymentCoordinator extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 50;
    private static final int RESPONSIBILITY_WEIGHT = 4;

    public PaymentCoordinator() {
        super("PaymentCoordinator", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "payment coordinator: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|PaymentCoordinator|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "payment.PaymentCoordinator";
    }
