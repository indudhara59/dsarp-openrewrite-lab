...
public final class OrderStateMachine {
    ...
    public OrderStateMachine(DiscountPolicy discountPolicy) {
    ...
    public CapabilityDecision decide(OrderContext context) {
        ...
        int score = Math.max(0, Math.min(100, 100 - payable.remainder(BigDecimal.valueOf(33)).intValue()));
        return new CapabilityDecision("OrderStateMachine", context.itemCount() > 0, score,
    ...
    public String capabilityKey() {
        return "ordercore.OrderStateMachine";
    }
