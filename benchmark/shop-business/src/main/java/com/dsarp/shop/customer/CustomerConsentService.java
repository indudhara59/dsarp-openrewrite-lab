...
/**
 * Owns the customer consent service decision within the customer responsibility.
 *
 ...
 */
public final class CustomerConsentService extends AbstractBusinessCapability {
    ...
    public CustomerConsentService() {
        super("CustomerConsentService", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "customer consent service: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|CustomerConsentService|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "customer.CustomerConsentService";
    }
