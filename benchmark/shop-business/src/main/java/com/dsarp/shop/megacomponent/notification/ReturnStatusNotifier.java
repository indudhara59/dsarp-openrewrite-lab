...
/**
 * Owns the return status notifier decision within the notification responsibility.
 *
 ...
 */
public final class ReturnStatusNotifier extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 54;
    private static final int RESPONSIBILITY_WEIGHT = 4;

    public ReturnStatusNotifier() {
        super("ReturnStatusNotifier", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "return status notifier: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|ReturnStatusNotifier|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "notification.ReturnStatusNotifier";
    }
