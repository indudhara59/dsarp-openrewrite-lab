...
/**
 * Owns the promotion performance reporter decision within the reporting responsibility.
 *
 ...
 */
public final class PromotionPerformanceReporter extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 46;
    private static final int RESPONSIBILITY_WEIGHT = 1;

    public PromotionPerformanceReporter() {
        super("PromotionPerformanceReporter", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "promotion performance reporter: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|PromotionPerformanceReporter|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "reporting.PromotionPerformanceReporter";
    }
