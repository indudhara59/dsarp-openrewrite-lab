...
/**
 * Owns the payment audit recorder decision within the audit responsibility.
 *
 ...
 */
public final class PaymentAuditRecorder extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 53;
    private static final int RESPONSIBILITY_WEIGHT = -1;

    public PaymentAuditRecorder() {
        super("PaymentAuditRecorder", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "payment audit recorder: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|PaymentAuditRecorder|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "audit.PaymentAuditRecorder";
    }
