...
/**
 * Owns the payment failure notifier decision within the notification responsibility.
 *
 ...
 */
public final class PaymentFailureNotifier extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 52;
    private static final int RESPONSIBILITY_WEIGHT = 2;

    public PaymentFailureNotifier() {
        super("PaymentFailureNotifier", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "payment failure notifier: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|PaymentFailureNotifier|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "notification.PaymentFailureNotifier";
    }
