...
/**
 * Owns the notification composer decision within the notification responsibility.
 *
 ...
 */
public final class NotificationComposer extends AbstractBusinessCapability {
    ...
    public NotificationComposer() {
        super("NotificationComposer", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "notification composer: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|NotificationComposer|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "notification.NotificationComposer";
    }
