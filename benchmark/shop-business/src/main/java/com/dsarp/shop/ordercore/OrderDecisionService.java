...
public final class OrderDecisionService {
    private final DiscountPolicy discountPolicy;

    public OrderDecisionService(DiscountPolicy discountPolicy) {
    ...
    public CapabilityDecision decide(OrderContext context) {
        ...
        int score = Math.max(0, Math.min(100, 100 - payable.remainder(BigDecimal.valueOf(40)).intValue()));
        return new CapabilityDecision("OrderDecisionService", context.itemCount() > 0, score,
    ...
    public String capabilityKey() {
        return "ordercore.OrderDecisionService";
    }
