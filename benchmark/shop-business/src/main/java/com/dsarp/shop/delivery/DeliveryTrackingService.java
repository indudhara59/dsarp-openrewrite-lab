...
/**
 * Owns the delivery tracking service decision within the delivery responsibility.
 *
 ...
 */
public final class DeliveryTrackingService extends AbstractBusinessCapability {
    ...
    public DeliveryTrackingService() {
        super("DeliveryTrackingService", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "delivery tracking service: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|DeliveryTrackingService|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "delivery.DeliveryTrackingService";
    }
