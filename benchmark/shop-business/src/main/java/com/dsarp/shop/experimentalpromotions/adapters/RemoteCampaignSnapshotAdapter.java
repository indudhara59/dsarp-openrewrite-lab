...
public final class RemoteCampaignSnapshotAdapter implements DiscountPolicy {
    private static final BigDecimal RATE = new BigDecimal("0.04");
    ...
    public String policyName() {
        return "RemoteCampaignSnapshotAdapter";
    }
