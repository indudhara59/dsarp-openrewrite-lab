...
public final class OrderFactory {
    ...
    public OrderFactory(DiscountPolicy discountPolicy) {
    ...
    public CapabilityDecision decide(OrderContext context) {
        ...
        int score = Math.max(0, Math.min(100, 100 - payable.remainder(BigDecimal.valueOf(31)).intValue()));
        return new CapabilityDecision("OrderFactory", context.itemCount() > 0, score,
