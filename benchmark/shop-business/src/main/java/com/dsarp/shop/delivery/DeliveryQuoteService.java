...
/**
 * Owns the delivery quote service decision within the delivery responsibility.
 *
 ...
 */
public final class DeliveryQuoteService extends AbstractBusinessCapability {
    ...
    public DeliveryQuoteService() {
        super("DeliveryQuoteService", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "delivery quote service: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|DeliveryQuoteService|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "delivery.DeliveryQuoteService";
    }
