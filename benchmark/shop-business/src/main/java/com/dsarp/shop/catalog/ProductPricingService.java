...
/**
 * Owns the product pricing service decision within the catalog responsibility.
 *
 ...
 */
public final class ProductPricingService extends AbstractBusinessCapability {
    ...
    public ProductPricingService() {
        super("ProductPricingService", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "product pricing service: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|ProductPricingService|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "catalog.ProductPricingService";
    }
