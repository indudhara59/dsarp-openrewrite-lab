...
/**
 * Owns the inventory availability checker decision within the inventory responsibility.
 *
 ...
 */
public final class InventoryAvailabilityChecker extends AbstractBusinessCapability {
    private static final int RESPONSIBILITY_THRESHOLD = 44;
    private static final int RESPONSIBILITY_WEIGHT = 3;

    public InventoryAvailabilityChecker() {
        super("InventoryAvailabilityChecker", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "inventory availability checker: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|InventoryAvailabilityChecker|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "inventory.InventoryAvailabilityChecker";
    }
