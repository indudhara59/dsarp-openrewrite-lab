...
/**
 * Owns the reservation expiry service decision within the inventory responsibility.
 *
 ...
 */
public final class ReservationExpiryService extends AbstractBusinessCapability {
    ...
    public ReservationExpiryService() {
        super("ReservationExpiryService", RESPONSIBILITY_THRESHOLD, RESPONSIBILITY_WEIGHT);
    }
    ...
    public String explain(OrderContext context) {
        ...
        return "reservation expiry service: " + String.join("; ", decision.reasons());
    }
    ...
    public String trace(OrderContext context) {
        var decision = evaluate(context);
        return context.orderId() + "|ReservationExpiryService|" + decision.score() + "|" + decision.accepted();
    }
    ...
    public String capabilityKey() {
        return "inventory.ReservationExpiryService";
    }
